...
#在这里瞎搞一下，把两个向量做做运算看看。
subtracted = keras.layers.Subtract()([q1, q2])
subtracted = Lambda(lambda x: K.abs(x))(subtracted)
multiplyed = keras.layers.multiply([q1, q2])
merged = concatenate([q1,q2,subtracted,multiplyed])
print("merged shape",merged.get_shape())
